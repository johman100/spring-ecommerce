...
public class Usuario {
	...
	public Usuario(Integer id, String nombre, String username, String email, String direccion, String telegono,
	...
	public String toString() {
		return "Usuario [id=" + id + ", nombre=" + nombre + ", username=" + username + ", email=" + email
				+ ", direccion=" + direccion + ", telegono=" + telegono + ", tipo=" + tipo + ", password=" + password
